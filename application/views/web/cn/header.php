            ...
            <div class="container">
                <div class="navbar-header">
                    <div class="navbar-brand">
                        <a title="KnowledgePress" href="<?=  site_url()?>cn"><img src="<?= base_url() ?>webassets/img/logo.png" alt="KnowledgePress"/></a>
                    </div>
...
<!--                            <li>                                
                                <label style="margin-top: 20px;color: #fff;font-weight: normal">的语言</label>
                            </li> -->
                            <li>                                
                                <a href="<?=  site_url()?>en" class="">英語</a>
                            </li>                        
                        </ul> 
                    </form>
                </nav> 
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-lg-8">
                        <h1>研究所 文件</h1>
                        <p class="tagline">搜索 & 發現 研究所 文件</p>
                    </div>
                    <div class="col-sm-4 col-lg-4">
                        <form role="search" method="post" id="searchform" class="form-search" action="<?= site_url() ?>cn/search">
                            <div class="append-icon">
                                <input type="text" value="" name="keyword" id="autocomplete-dynamic" class="form-control input-lg" autocomplete="off" placeholder="搜索...">
